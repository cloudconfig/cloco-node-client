...
class ClocoClient {
    ...
    initializeApplication() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let filename = `${file_system_1.FileSystem.getUserHome()}/.cloco/cache/application_${this.options.application}`;
            try {
    ...
    loadConfigurationObjectWrapperFromApi(objectId, initializing) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let filename = `${file_system_1.FileSystem.getUserHome()}/.cloco/cache/configuration_${this.options.application}_${objectId}_${this.options.environment}`;
            let wrapper;
            try {
