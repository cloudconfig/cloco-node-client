...
class PassthroughEncryptor {
     ...
     */
    encrypt(data) {
        logger_1.Logger.log.debug("PassthroughEncryptor.encrypt: start.");
        logger_1.Logger.log.debug(`PassthroughEncryptor.encrypt: Received object of type '${typeof data}'`);
        return data;
    }
    /**
     ...
     */
    decrypt(encrypted) {
        logger_1.Logger.log.debug("PassthroughEncryptor.decrypt: start.");
        logger_1.Logger.log.debug(`PassthroughEncryptor.decrypt: Received object of type '${typeof encrypted}'`);
        try {
